...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_categorie_name_fkey` FOREIGN KEY (`categorie_name`) REFERENCES `categories`(`name`) ON DELETE RESTRICT ON UPDATE CASCADE;
